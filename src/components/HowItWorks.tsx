  ...
  return (
    <div className="space-y-24 pb-20">
      ...
      <section className="text-center pt-12 max-w-4xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mt-12 max-w-4xl mx-auto">
          <button 
            ...
            className={`p-4 rounded-2xl text-left border transition-all flex items-start space-x-3 ${activeFlow === 1 ? 'glass-panel border-brand-500/40 shadow-sm ring-1 ring-brand-400' : 'bg-white/5 border-white/10 hover:bg-white/10/50'}`}
          >
            <div className={`p-2 rounded-lg ${activeFlow === 1 ? 'bg-brand-600 text-white' : 'bg-white/10 text-slate-400'}`}>
              <ScanLine className="h-4 w-4" />
            </div>
            <div>
              <h4 className="text-xs font-bold text-white">Flow 1: Digitize & Save</h4>
              <p className="text-[10px] text-slate-500 mt-0.5">Scan grocery slips to build active pantry list</p>
            </div>
          </button>

          <button 
            onClick={() => setActiveFlow(2)}
            className={`p-4 rounded-2xl text-left border transition-all flex items-start space-x-3 ${activeFlow === 2 ? 'glass-panel border-brand-500/40 shadow-sm ring-1 ring-brand-400' : 'bg-white/5 border-white/10 hover:bg-white/10/50'}`}
          >
            <div className={`p-2 rounded-lg ${activeFlow === 2 ? 'bg-brand-600 text-white' : 'bg-white/10 text-slate-400'}`}>
              <Utensils className="h-4 w-4" />
            </div>
            <div>
              <h4 className="text-xs font-bold text-white">Flow 2: Cook & Log</h4>
              <p className="text-[10px] text-slate-500 mt-0.5">Follow guided recipes with zero-click calorie log</p>
            </div>
          </button>

          <button 
            onClick={() => setActiveFlow(3)}
            className={`p-4 rounded-2xl text-left border transition-all flex items-start space-x-3 ${activeFlow === 3 ? 'glass-panel border-brand-500/40 shadow-sm ring-1 ring-brand-400' : 'bg-white/5 border-white/10 hover:bg-white/10/50'}`}
          >
            <div className={`p-2 rounded-lg ${activeFlow === 3 ? 'bg-brand-600 text-white' : 'bg-white/10 text-slate-400'}`}>
              <Calendar className="h-4 w-4" />
            </div>
            <div>
              <h4 className="text-xs font-bold text-white">Flow 3: Prep & Portion</h4>
              <p className="text-[10px] text-slate-500 mt-0.5">Scale bulk recipes and track container shelf-lives</p>
            </div>
          </button>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-5 glass-panel p-6 rounded-2xl border border-white/10 shadow-xl space-y-4">
              <div className="flex items-center justify-between border-b border-white/5 pb-3">
                <span className="text-xs font-mono font-bold text-slate-600">DIGITAL PANTRY INVENTORY</span>
              ...
              <div className="space-y-2">
                <div className="p-3 bg-slate-950 rounded-xl border border-white/10 flex items-center justify-between text-xs">
                  <div className="flex items-center space-x-2">
                    <span className="w-2.5 h-2.5 rounded-full bg-green-500" />
                    <span className="font-semibold text-slate-200">Fresh Salmon Fillet</span>
                  </div>
                  <span className="text-slate-600 font-mono">Qty: 400g • Expires tomorrow</span>
                </div>
                <div className="p-3 bg-slate-950 rounded-xl border border-white/10 flex items-center justify-between text-xs">
                  <div className="flex items-center space-x-2">
                    <span className="w-2.5 h-2.5 rounded-full bg-yellow-500" />
                    <span className="font-semibold text-slate-200">Organic Baby Spinach</span>
                  </div>
                  <span className="text-slate-600 font-mono">Qty: 1 bag • Expires in 2 days</span>
                </div>
              </div>

              <div className="bg-brand-500/10 border border-brand-500/30 p-3 rounded-xl flex items-center justify-between text-xs text-brand-400 font-medium">
                <span>Plately suggests: "Pan-Seared Salmon Salad"</span>
                <button 
                  onClick={() => setActiveFlow(2)}
                  className="font-bold flex items-center space-x-0.5 text-brand-300 hover:underline"
                >
                  <span>Cook</span>
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="space-y-6 relative border-l border-white/10 pl-6 ml-3">
                ...
                <div className="relative">
                  ...
                  <h4 className="text-sm font-bold text-white">Scan Grocery Receipts</h4>
                ...
                <div className="relative">
                  ...
                  <h4 className="text-sm font-bold text-white">Plately Builds Digital Fridge</h4>
                  <p className="text-xs text-slate-400 font-sans mt-1 leading-relaxed">
                ...
                <div className="relative">
                  ...
                  <h4 className="text-sm font-bold text-white">Get Proactive Expiry Alerts</h4>
                  <p className="text-xs text-slate-400 font-sans mt-1 leading-relaxed">
        ...
        {activeFlow === 2 && (
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            {/* Visual Column */}
            <div className="lg:col-span-5 glass-panel p-6 rounded-2xl border border-white/10 shadow-xl space-y-4">
              <div className="bg-brand-950 text-white p-4 rounded-xl flex items-center justify-between">
                <div>
                  <p className="text-[10px] font-bold text-brand-300">ACTIVE SESSION</p>
                  <h4 className="text-xs font-bold">Salmon & Crisp Spinach</h4>
                </div>
                <span className="text-[10px] bg-brand-800 text-brand-300 px-2 py-0.5 rounded font-mono">Step 2 of 3</span>
              </div>
              ...
              <div className="p-3.5 bg-emerald-500/10 border border-emerald-500/20 rounded-xl flex items-center justify-between text-xs text-emerald-800 font-semibold">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="space-y-6 relative border-l border-white/10 pl-6 ml-3">
                ...
                <div className="relative">
                  <span className="absolute -left-[35px] top-1 w-6 h-6 rounded-full bg-brand-600 text-white text-xs font-bold font-mono flex items-center justify-center">1</span>
                  <h4 className="text-sm font-bold text-white">Select an Inventory-Aware Recipe</h4>
                  <p className="text-xs text-slate-400 font-sans mt-1 leading-relaxed">
                ...
                <div className="relative">
                  <span className="absolute -left-[35px] top-1 w-6 h-6 rounded-full bg-brand-600 text-white text-xs font-bold font-mono flex items-center justify-center">2</span>
                  <h4 className="text-sm font-bold text-white">Follow Guided Cooking steps</h4>
                  <p className="text-xs text-slate-400 font-sans mt-1 leading-relaxed">
                ...
                <div className="relative">
                  <span className="absolute -left-[35px] top-1 w-6 h-6 rounded-full bg-brand-600 text-white text-xs font-bold font-mono flex items-center justify-center">3</span>
                  <h4 className="text-sm font-bold text-white">Auto-Log Your Macro Profile</h4>
                  <p className="text-xs text-slate-400 font-sans mt-1 leading-relaxed">
        ...
        {activeFlow === 3 && (
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-5 glass-panel p-6 rounded-2xl border border-white/10 shadow-xl space-y-4">
              <div className="flex items-center justify-between border-b border-white/5 pb-3">
                <span className="text-xs font-mono font-bold text-slate-600">MEAL PREP BOX MANAGER</span>
                <span className="text-[10px] bg-blue-500/10 text-blue-400 border border-blue-200 px-2 py-0.5 rounded font-bold">Batch Cooking</span>
              </div>

              <div className="space-y-2">
                <div className="p-3.5 bg-slate-950 rounded-xl border border-white/10 flex items-center justify-between text-xs">
                  <div>
                    <p className="font-bold text-slate-200">Spiced Beef Sweet Potato bowls</p>
                    <p className="text-[10px] text-slate-600">Box 1-4 • Refrigerator Shelf 3</p>
                  </div>
                ...
                <div className="p-3.5 bg-slate-950 rounded-xl border border-white/10 flex items-center justify-between text-xs">
                  <div>
                    <p className="font-bold text-slate-200">Cajun Chicken Quinoa</p>
                    <p className="text-[10px] text-slate-600">Box 5-8 • Freezer Chest</p>
                  </div>
                  <span className="px-2 py-1 bg-blue-500/10 text-blue-400 border border-blue-200 font-bold text-[10px] rounded font-mono">
                    Frozen safe
                  </span>
                </div>
              </div>
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="space-y-6 relative border-l border-white/10 pl-6 ml-3">
                ...
                <div className="relative">
                  <span className="absolute -left-[35px] top-1 w-6 h-6 rounded-full bg-brand-600 text-white text-xs font-bold font-mono flex items-center justify-center">1</span>
                  <h4 className="text-sm font-bold text-white">Select serving scale count</h4>
                  <p className="text-xs text-slate-400 font-sans mt-1 leading-relaxed">
                ...
                <div className="relative">
                  <span className="absolute -left-[35px] top-1 w-6 h-6 rounded-full bg-brand-600 text-white text-xs font-bold font-mono flex items-center justify-center">2</span>
                  <h4 className="text-sm font-bold text-white">Register Plastic Container Boxes</h4>
                  <p className="text-xs text-slate-400 font-sans mt-1 leading-relaxed">
                ...
                <div className="relative">
                  <span className="absolute -left-[35px] top-1 w-6 h-6 rounded-full bg-brand-600 text-white text-xs font-bold font-mono flex items-center justify-center">3</span>
                  <h4 className="text-sm font-bold text-white">Defrost & Swipe Away</h4>
                  <p className="text-xs text-slate-400 font-sans mt-1 leading-relaxed">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-8">
        <div className="bg-brand-500/10 border border-brand-500/30 rounded-3xl p-8 max-w-3xl mx-auto space-y-4">
          <p className="text-xs font-bold text-brand-400 uppercase tracking-widest">GET FIRST-HAND EXPERIENCE</p>

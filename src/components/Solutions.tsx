  ...
  return (
    <div className="space-y-24 pb-20">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-24">
        ...
        <div id="solution-food-waste" className="glass-panel rounded-3xl border border-white/10 p-8 md:p-12 shadow-sm grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative overflow-hidden">
          <div className="absolute top-0 right-0 w-32 h-32 bg-brand-500/20/50 rounded-full blur-2xl pointer-events-none" />
          
          <div className="lg:col-span-7 space-y-6">
            <div className="inline-flex items-center space-x-1.5 text-xs font-semibold text-brand-400 bg-brand-500/10 border border-brand-500/30 px-3 py-1 rounded-full">
            ...
            <div className="grid grid-cols-3 gap-4 pt-4 border-t border-white/5">
              <div>
                <p className="text-xl font-black font-display text-brand-500">$1,500+</p>
                <p className="text-[10px] text-slate-500 font-sans uppercase">Avg. Money Saved</p>
              </div>
              <div>
                <p className="text-xl font-black font-display text-brand-500">80%</p>
                <p className="text-[10px] text-slate-500 font-sans uppercase">Waste Reduced</p>
              </div>
              <div>
                <p className="text-xl font-black font-display text-brand-500">30kg</p>
                <p className="text-[10px] text-slate-500 font-sans uppercase">CO2 Prevented</p>
              </div>
            </div>
          ...
          <div className="lg:col-span-5 bg-slate-950 rounded-2xl p-6 border border-white/10 space-y-4">
            <h4 className="text-xs font-mono font-bold text-slate-600 uppercase tracking-wider">REAL WORLD HOUSEHOLD EXPERIENCE</h4>
            ...
            <div className="flex items-center space-x-2 pt-2 border-t border-white/10">
              <div className="w-8 h-8 rounded-full bg-emerald-500/15 flex items-center justify-center font-bold text-emerald-800 text-xs">
                S
              </div>
              <div>
                <p className="text-[11px] font-bold text-slate-200">The Sullivans</p>
                <p className="text-[9px] text-slate-500">4-person household in Oregon</p>
              </div>
            </div>
          </div>
        ...
        <div id="solution-healthy-eating" className="glass-panel rounded-3xl border border-white/10 p-8 md:p-12 shadow-sm grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative overflow-hidden">
          <div className="absolute top-0 right-0 w-32 h-32 bg-emerald-500/15/50 rounded-full blur-2xl pointer-events-none" />
          
          <div className="lg:col-span-5 bg-slate-950 rounded-2xl p-6 border border-white/10 space-y-4 order-last lg:order-first">
            <h4 className="text-xs font-mono font-bold text-slate-600 uppercase tracking-wider">FITNESS INCORPORATION CASE STUDY</h4>
            <p className="text-xs italic text-slate-400 leading-relaxed font-sans">
            ...
            <div className="flex items-center space-x-2 pt-2 border-t border-white/10">
              ...
              <div>
                <p className="text-[11px] font-bold text-slate-200">Marcus Vance</p>
                <p className="text-[9px] text-slate-500">Marathon Prep & Amateur Baker</p>
              </div>
            </div>
          </div>

          <div className="lg:col-span-7 space-y-6">
            <div className="inline-flex items-center space-x-1.5 text-xs font-semibold text-emerald-800 bg-emerald-500/10 border border-emerald-500/20 px-3 py-1 rounded-full">
            ...
            <div className="grid grid-cols-3 gap-4 pt-4 border-t border-white/5">
              <div>
                ...
                <p className="text-[10px] text-slate-500 font-sans uppercase">Automatic logging</p>
              </div>
              <div>
                <p className="text-xl font-black font-display text-emerald-600">Google</p>
                <p className="text-[10px] text-slate-500 font-sans uppercase">Fit & Health Sync</p>
              </div>
              <div>
                <p className="text-xl font-black font-display text-emerald-600">AI Scan</p>
                <p className="text-[10px] text-slate-500 font-sans uppercase">Macro Photo Parser</p>
              </div>
            </div>
        ...
        <div id="solution-decision-fatigue" className="glass-panel rounded-3xl border border-white/10 p-8 md:p-12 shadow-sm grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative overflow-hidden">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="grid grid-cols-3 gap-4 pt-4 border-t border-white/5">
              <div>
                ...
                <p className="text-[10px] text-slate-500 font-sans uppercase">To start skillet</p>
              </div>
              <div>
                <p className="text-xl font-black font-display text-yellow-600">15 min</p>
                <p className="text-[10px] text-slate-500 font-sans uppercase">Speed prep options</p>
              </div>
              <div>
                <p className="text-xl font-black font-display text-yellow-600">0 Ads</p>
                <p className="text-[10px] text-slate-500 font-sans uppercase">Zero blog essays</p>
              </div>
            </div>
          ...
          <div className="lg:col-span-5 bg-slate-950 rounded-2xl p-6 border border-white/10 space-y-4">
            <h4 className="text-xs font-mono font-bold text-slate-600 uppercase tracking-wider">PROFESSIONAL WORK-WEEK VERDICT</h4>
            <p className="text-xs italic text-slate-400 leading-relaxed font-sans">
            ...
            <div className="flex items-center space-x-2 pt-2 border-t border-white/10">
              ...
              <div>
                <p className="text-[11px] font-bold text-slate-200">Claire Lin</p>
                <p className="text-[9px] text-slate-500">Strategy Consultant at McKinsey</p>
              </div>
            </div>
          </div>
        ...
        <div id="solution-meal-prep" className="glass-panel rounded-3xl border border-white/10 p-8 md:p-12 shadow-sm grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative overflow-hidden">
          <div className="absolute top-0 right-0 w-32 h-32 bg-blue-100/50 rounded-full blur-2xl pointer-events-none" />
          
          <div className="lg:col-span-5 bg-slate-950 rounded-2xl p-6 border border-white/10 space-y-4 order-last lg:order-first">
            <h4 className="text-xs font-mono font-bold text-slate-600 uppercase tracking-wider">BULK BATCH PREPARATION FEEDBACK</h4>
            <p className="text-xs italic text-slate-400 leading-relaxed font-sans">
            ...
            <div className="flex items-center space-x-2 pt-2 border-t border-white/10">
              ...
              <div>
                <p className="text-[11px] font-bold text-slate-200">Jordan Reyes</p>
                <p className="text-[9px] text-slate-500">Powerlifter & High school Coach</p>
              </div>
            </div>
          </div>

          <div className="lg:col-span-7 space-y-6">
            <div className="inline-flex items-center space-x-1.5 text-xs font-semibold text-blue-800 bg-blue-500/10 border border-blue-200 px-3 py-1 rounded-full">
            ...
            <div className="grid grid-cols-3 gap-4 pt-4 border-t border-white/5">
              <div>
                ...
                <p className="text-[10px] text-slate-500 font-sans uppercase">Saved per week</p>
              </div>
              <div>
                <p className="text-xl font-black font-display text-blue-600">Label</p>
                <p className="text-[10px] text-slate-500 font-sans uppercase">Barcode system</p>
              </div>
              <div>
                <p className="text-xl font-black font-display text-blue-600">Freezer</p>
                <p className="text-[10px] text-slate-500 font-sans uppercase">Defrost alerts</p>
              </div>
            </div>
      ...
      <section className="bg-slate-900 text-white py-16 text-center max-w-7xl mx-auto rounded-3xl">
        <div className="max-w-2xl mx-auto space-y-6 px-4">
          ...
          <button 
            onClick={onOpenBetaModal}
            className="px-8 py-4 bg-brand-500 hover:bg-brand-600 text-white font-bold rounded-xl transition-all shadow-lg text-xs"
          >
